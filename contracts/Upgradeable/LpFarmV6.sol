    ...
    ILpFarm
{
        ...
        nonReentrant
    {
        ...
        IKlayswapSinglePool(address(pool.lpToken)).claimReward();
    ...
    /**
     ...
     @notice sets vxSIG Address of the contract.
     */
    function setMiningRateHelper(address _miningRateHelper) external onlyOwner {
        miningRateHelper = ILpFarmMiningRateHelperV1(_miningRateHelper);
    }
        ...
        nonReentrant
    {
        ...
        //[Update] V5 added.
        miningRateHelper.updateUserReward(_pid, msg.sender);
        miningRateHelper.claimReward(_pid, msg.sender);
    ...
    /**
        @notice [Update] V5 added function
        @notice claim mining rate KSP.
     */

    function claimMiningRateReward(uint256 _pid)
        external
        whenNotPaused
        nonReentrant
    {
