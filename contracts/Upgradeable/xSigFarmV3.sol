    ...
    IxSIGFarm
{
    ...
    /// @notice [Update] V3 appended value
    ISigmaGovern public sigmaGovern;
    ...
    /**
     @notice [V3 ADDED] set the klayswap govern contract address.
     @param _sigmaGovernAddress the new sigmaGovernAddress govern address.
     */

    function setSigmaGovern(address _sigmaGovernAddress) external onlyOwner {
        sigmaGovern = ISigmaGovern(_sigmaGovernAddress);
    }
        ...
        nonReentrant
    {
        ...
        /// @notice [Update] V3 appended line
        sigmaGovern.cancelUserVotes(msg.sender);
