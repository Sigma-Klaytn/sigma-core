...
contract VestingWallet is Ownable {
    ...
    /**
     @notice This transfer ownership as well. 
     */
    function setBeneficiaryAddress(address beneficiaryAddress)
        external
        onlyOwner
    {
        require(
    ...
    /* ========== End of Restricted Function End ========== */
    ...
    function release() public virtual {
        ...
        require(releasable > 0, "No releasable amount of token.");
