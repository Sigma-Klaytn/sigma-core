...
contract KSPVault  {
    ...
    event LOCK_KSP(uint amount, uint lockPeriodRequested);

    function lockKSP(uint _amount,uint _lockPeriodRequested) external {
    ...
    function transferToken(address _token, address _to, uint _amount) external {
