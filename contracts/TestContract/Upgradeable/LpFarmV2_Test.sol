    ...
    PausableUpgradeable
{
    ...
    function deposit(uint256 _pid, uint256 _amount)
        ...
        nonReentrant
    {
        require(_amount >= 1 ether, "User should deposit more than 1 token.");
    ...
    function userBoostWeight(uint256 _pid, address _user)
        external
        view
        returns (uint256)
    {
        UserInfo memory user = userInfo[_pid][_user];
        return user.boostWeight;
    }
}
