...
// This is contract just for test purpose.
// Never use this for production.

contract UpgradeableTokenSaleV2 is
    Initializable,
    UUPSUpgradeable,
    OwnableUpgradeable,
    ...
    PausableUpgradeable
{
    ...
    function withdrawTokens() external whenNotPaused nonReentrant {
        ...
        uint256 amount = (portion * TOTAL_SIG_SUPPLY) / 1e18 / 2; // JUST FOR THE UPGRADEABLE SMART CONTRACT TEST
