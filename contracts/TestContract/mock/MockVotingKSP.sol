...
contract MockVotingKSP is IERC20{
    ...
    event LockedToken(address user, uint256 amount,uint lockPeriodRequested);
   ...
   constructor(
    ...
    function lockKSP(uint256 amount, uint256 lockPeriodRequested) external {
        ...
        require(lockPeriodRequested > 0 ,"LockPErioudRequested should be bigger than 0");
