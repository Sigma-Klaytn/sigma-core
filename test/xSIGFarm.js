...
contract('xSIGFarm', function (accounts) {
    ...
    describe('Test : 0.SetInitialInfo', () => {
        ...
        it('Test : 0.SetInitialInfo', async () => {
            ...
            await expectRevert(xSIGFarm.setInitialInfo(xSIGToken.address, vxSIGToken.address, { from: userA }), 'Ownable: caller is not the owner')

            // //2. Check if Initial Info has been set. 
            await xSIGFarm.setInitialInfo(xSIGToken.address, vxSIGToken.address, { from: root })
